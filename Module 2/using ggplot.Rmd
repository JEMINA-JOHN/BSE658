...
```{r}
ggplot(data = state_data, mapping = aes(x=Date, y=Positive)) + geom_jitter(width = 1, height = 20)
```

```{r}
ggplot(data = state_data, mapping = aes(x=Date, y=Positive)) + geom_line(linewidth = 1)
```
...
<https://uc-r.github.io/ggplot_intro> <http://r-statistics.co/Complete-Ggplot2-Tutorial-Part1-With-R-Code.html>
